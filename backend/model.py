...
class WeatherModel:
    ...
    def predict(self, features):
        ...
        predictions["min_temp"] = joblib.load('random_forest_min.pkl').predict([features])[0]
        predictions["max_temp"] = joblib.load('random_forest_max.pkl').predict([features])[0]
        
        predictions["humidity_9am"] = joblib.load('random_forest_humidity_9am.pkl').predict([features])[0]
        predictions["humidity_3pm"] = joblib.load('random_forest_humidity_3pm.pkl').predict([features])[0]
        
        predictions["wind_speed_9am"] = joblib.load('random_forest_wind_speed_9am.pkl').predict([features])[0]
        predictions["wind_speed_3pm"] = joblib.load('random_forest_wind_speed_3pm.pkl').predict([features])[0]
